...
import (
	"github.com/lucaspichi06/patrones-diseno-go/src/estructurales/10-proxy/book"
	"github.com/lucaspichi06/patrones-diseno-go/src/estructurales/10-proxy/remote"
)
